...
function btn_back() {	
	c_ShowProgressBar(); 
	$("#detailForm").attr( "action", "pd003002back.do");	
	$("#detailForm").submit();
}
</script>
</head>
...
<form id="detailForm" action="" method="post" >
	...
	<%/*共通隐藏字段 end*/%>	 
	<div class="div_navi"><span><img src="<%= request.getContextPath()%>/resources/images/home.png">&nbsp;您当前的位置：审核管理&nbsp;&gt;&nbsp;副总审核&nbsp;&gt;&nbsp;休假申请明细</span></div>
