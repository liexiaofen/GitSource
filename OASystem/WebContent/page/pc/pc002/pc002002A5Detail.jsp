...
function btn_back() {	
	c_ShowProgressBar(); 
	$("#detailForm").attr( "action", "pc002002back.do");	
	$("#detailForm").submit();
}
...
<form id="detailForm" action="" method="post" >
	...
	<%/*共通隐藏字段 end*/%>	 
	<div class="div_navi"><span><img src="<%= request.getContextPath()%>/resources/images/home.png">&nbsp;您当前的位置：申请管理&nbsp;&gt;&nbsp;申请管理&nbsp;&gt;&nbsp;出差取消申请明细</span></div>
	
	<jsp:include page="../../pgcommon/Apply_A5Detail.jsp"></jsp:include>
