...
function btn_apply() {	
	...
	var extraworkstarthm = $("#extraworkstarthm").val();
	var extraworkendhm = $("#extraworkendhm").val();
	var extraworkstart = $("#extraworkstart").val();
	var extraworkend = $("#extraworkend").val();
	if(!checkTimeBgnEndDate( extraworkstart, extraworkend, extraworkstarthm, extraworkendhm)){
