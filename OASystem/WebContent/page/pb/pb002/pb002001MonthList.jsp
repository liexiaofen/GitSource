...
<script type="text/javascript">
	...
	*/
	function btn_back() {	
		c_ShowProgressBar(); 
		$("#queryForm").attr( "action", "pb002002back.do");	
		$("#queryForm").submit();
	}
</script>
<STYLE type=text/css>
...
<form id="queryForm" action="" method="post" >
	<%/*共通隐藏字段 start*/%>
	<input name="pb002001searchcommand.orgcdid" type="hidden"  value="${command.pb002001searchcommand.orgcdid}" />
	<input name="pb002001searchcommand.dailydevicename" type="hidden"  value="${command.pb002001searchcommand.dailydevicename}" />
	<input name="pb002001searchcommand.displaydate" type="hidden"  value="${command.pb002001searchcommand.displaydate}" />
	<%/*共通隐藏字段 end*/%>	
	<div class="div_navi"><span><img src="<%= request.getContextPath()%>/resources/images/home.png">&nbsp;您当前的位置：日程管理&nbsp;&gt;&nbsp;设备空闲&nbsp;&gt;&nbsp;月预定信息</span></div>
	<DIV id=wrap>
		<SCRIPT type=text/javascript>
