	    ...
	    <tbody>
			<tr>
				...
				<td class="td_value" width="26%">
					<dict:select1 id="orgcdid" name="orgcdid" sqlid="select orgcdid as busidictid,orgshortname as busidictname  from s_organize where deletefg = '0' order by sortno" value="${searchCommand.orgcdid}" cssClass="input_select" nullLabel="全部"></dict:select1>
				</td>
