package com.winsolution.weixin.mybatis.interceptor;
...
import com.winsolution.weixin.entity.PageEntity;
		...
		if (ivk.getTarget() instanceof RoutingStatementHandler) {
			...
			if (mappedStatement.getId().matches(pageSqlId)) { // 拦截需要分页的SQL
				...
				if (parameterObject == null) {
					...
					String countSql = "select count(0) from (" + sql + ") myCount";// 记录统计
					...
					if (parameterObject instanceof PageEntity) { // 参数就是Page父类的实例
