...
public class MessageUtil {	
	 ...
	 * 返回消息类型：签到
	 */
	public static final String RESP_MESSAGE_TYPE_QD = "KQDJ_QD";
	
	/**
	 * 返回消息类型：签退
	 */
	public static final String RESP_MESSAGE_TYPE_QT = "KQDJ_QT";
	 ...
	 * 请求消息类型：地理位置选择
	 */
	public static final String REQ_MESSAGE_TYPE_LOCATION_SELECT = "location_select";
	 ...
	 * 请求消息类型：推送
	 */
	public static final String REQ_MESSAGE_TYPE_EVENT_AGENT = "event_agent";
